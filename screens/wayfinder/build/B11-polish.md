...
4. **Token audit vs AGENTS.md:** no hardcoded px (small details only), rem/em text+spacing, %/fr layout; verify against the starter's globals.css tokens; run the design-system lint.
